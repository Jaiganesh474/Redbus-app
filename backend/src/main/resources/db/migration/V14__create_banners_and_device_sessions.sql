...
INSERT INTO banners (tag, title, subtitle, cta_text, cta_link, bg_gradient, badge_color, image_url, accent, route, promo_code, discount_percent, is_active, priority)
VALUES 
